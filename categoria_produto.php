...
<div class="conteudo">
	...
	<div class="Letranovidadeleft" style=" clear: both; margin-bottom:px;">
							...
							<div class="letra30calibra"><?php echo $categoria_titulo;?></div>
	...
	<div class="produto">
		<div class="imagem_produto">
			<a href="./uploads/fotos/g_<?php echo $imagem_imagem;?>" rel="lightbox[roadtrip]">
				<img src="./uploads/fotos/g_<?php echo $imagem_imagem;?>" alt="brothersdoasfalto" title="brothersdoasfalto" name="brothersdoasfalto" border="0" width="138px" height="120px" />
			</a>
		</div>
